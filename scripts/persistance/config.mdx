...
<ResponseField name="Config.KeysSystem" type="string">
  The vehicle keys script you are using. Currently supported: `"qb-vehiclekeys"`, `"jaksam-vehicles-keys"`, `"qs-vehiclekeys"`, `"t1ger_keys"`, `"wasabi_carlock"`, `"standalone"`. For standalone, you need to configure `bridge/keys/standalone`.
</ResponseField>
